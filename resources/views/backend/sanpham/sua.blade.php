    ...
    <div class="panel-body">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <br>
                <img src="{!! asset('upload/sanpham/'.$sanpham->sanpham_anh) !!}" class="img-responsive img-rounded" alt="Image" style="width: 150px; height: 200px;">
        ...
        <div class="col-lg-6">
            ...
            @foreach ($images as $key => $img)
                <div class="form-group" id="{!! $key !!}">
                    <br>
                    <img src="{!! asset('/upload/chitietsanpham/'.$img->hinhsanpham_ten) !!}" class="img-responsive img-rounded" alt="Image" style="width: 150px; height: 200px;" class="img_detail" idHinh="{!! $img->id !!}" id="{!! $key !!}">
